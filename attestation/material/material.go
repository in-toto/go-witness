...
func (a *Attestor) Attest(ctx *attestation.AttestationContext) error {
	...
	materials, err := file.RecordArtifacts(ctx.WorkingDir(), nil, ctx.Hashes(), map[string]struct{}{}, false, map[string]bool{}, ctx.DirHashGlob(), compiledIncludeGlob, compiledExcludeGlob)
	if err != nil {
		return err
	}
