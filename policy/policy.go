...
type Policy interface {
	Verify(ctx context.Context, opts ...VerifyOption) (bool, map[string]StepResult, error)
}
...
func (p PolicyV1) PublicKeyVerifiers(ko map[string][]func(signer.SignerProvider) (signer.SignerProvider, error)) (map[string]cryptoutil.Verifier, error) {
...
func (p PolicyV1) TrustBundles() (map[string]TrustBundle, error) {
	return trustBundlesFromRoots(p.Roots)
}

func (p PolicyV1) TimestampAuthorityTrustBundles() (map[string]TrustBundle, error) {
...
func (p PolicyV1) Verify(ctx context.Context, opts ...VerifyOption) (bool, map[string]StepResult, error) {
	vo := &VerifyOptions{
		SearchDepth: 3,
	}
...
func (p PolicyV1) verifyV1(ctx context.Context, vo *VerifyOptions, trustBundles map[string]TrustBundle) (bool, map[string]StepResult, error) {
...
func (p PolicyV1) verifyArtifacts(resultsByStep map[string]StepResult) (map[string]StepResult, error) {
